...
if (isset($_POST['krijo']))
{
    ...
    if (is_null($njoftim)) {
        ...
        header("location:krijo_klase.php");
        }
        else
        {
            $njoftim="Klasa nuk u krijua, provo perseri!!";
...
}//Mbarimi i ksuhtit qe krijon nje klase
...
<section class="content">
                        ...
                        <div class="callout callout-success">
                            <h4>Klasat</h4> 
                            <p>
                                Ne kete sesion ju mund te shikoni klasat tuaja ose te krijoni nje te tille. 
                            </p>
                        </div>
                        <div class="row">
        <div class="col-md-8">
...
<a onclick="return confirm('Jeni te sigurte qe doni te fshini kete?')" class="btn btn-xs btn-danger" href="del/fshi_klas.php?id=<?= $te_dhena->id_klasa ?>"><i class="fa fa-times"></i>Fshij</a>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group-sm">
                                            ...
                                            <input type="text" id="employees_fullName" name="emri_klases" required="required" class="form-control">
